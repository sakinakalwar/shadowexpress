...
const services = [
  { title: "Air Freight",     desc: "Fast, secure solutions for urgent and global shipments.",                       img: IMG_PLANE },
  { title: "Road Transport",  desc: "Reliable, cost-effective local and regional deliveries.",                       img: IMG_TRUCK },
  { title: "Ocean Freight",   desc: "Affordable solutions for large-volume international shipments.",                img: IMG_WAREHOUSE },
  { title: "Rail Freight",    desc: "Efficient, eco-friendly transport for heavy cargo.",                            img: IMG_TEAM },
  { title: "Warehousing",     desc: "Secure, scalable storage and distribution solutions.",                         img: IMG_WAREHOUSE },
  { title: "Cargo Insurance", desc: "Comprehensive protection against loss and damage.",                             img: IMG_PLANE },
  { title: "Engineering",     desc: "Supply chain optimization solutions for complex industries.",                   img: IMG_TEAM },
  { title: "Construction",    desc: "Professional logistics services protecting goods during transport.",            img: IMG_TRUCK },
];
...
const insights = [
  { title: "The Future of Supply Chain Management",   date: "June 10, 2025", img: IMG_WAREHOUSE },
  { title: "How Air Freight is Reshaping Global Trade", date: "June 8, 2025", img: IMG_PLANE },
  { title: "Top 5 Tips for Efficient Warehousing",    date: "June 5, 2025",  img: IMG_TEAM },
  { title: "Road Transport: Going the Extra Mile",    date: "June 3, 2025",  img: IMG_TRUCK },
  { title: "Understanding Cargo Insurance Coverage",  date: "June 1, 2025",  img: IMG_PLANE },
  { title: "Sustainability in Modern Logistics",      date: "May 29, 2025",  img: IMG_WAREHOUSE },
];

const partners = ["DHL Express", "FedEx", "UPS Logistics", "Maersk Line", "MSC Cargo", "CEVA Logistics"];
    ...
    <div className="bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div variants={fadeLeft} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}
            ...
            <div className="absolute top-0 right-0 left-20 h-[300px] rounded-lg overflow-hidden shadow-lg">
              <img src={aboutImg} alt="Logistics operations" className="w-full h-full object-cover" />
            </div>
            <div className="absolute bottom-0 left-0 w-[270px] h-[190px] rounded-lg overflow-hidden shadow-xl border-4 border-white">
              <img src={IMG_TEAM} alt="Our team" className="w-full h-full object-cover" />
            </div>
            <div className="absolute top-4 left-0 z-10 bg-red-600 rounded-lg p-5 text-white shadow-lg">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Our Company In Numbers</h2>
              <p className="text-gray-300 leading-relaxed max-w-sm">
                Backed by decades of experience and a global network spanning 80+ countries, we deliver results that speak for themselves.
              </p>
            </motion.div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 items-center">
            {partners.map((p, i) => (
              <motion.div key={p} variants={fadeUp} custom={i}
                initial="hidden" whileInView="visible" viewport={{ once: true }}
                className="flex items-center justify-center h-16 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow px-4">
                <span className="text-gray-600 font-bold text-sm text-center">{p}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-red-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-white mb-4">Stay Connected With Us</h2>
            <p className="text-red-100 leading-relaxed mb-8 max-w-lg mx-auto">
              A regularly distributed publication containing news, updates, and information about logistics and our services.
            </p>
            <form
              className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto"
              onSubmit={e => { e.preventDefault(); setName(""); }}>
              <input
                type="text"
                placeholder="Your Name"
                value={name}
                onChange={e => setName(e.target.value)}
                className="flex-1 px-5 py-3 rounded text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-white"
              />
              <button type="submit"
                className="px-8 py-3 bg-gray-900 text-white font-bold uppercase tracking-wide text-sm rounded hover:bg-gray-800 transition-colors">
                Sign Up
              </button>
            </form>
          </motion.div>
